    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
        <motion.div
          ...
          className="glass-panel w-full max-w-lg rounded-3xl p-6 lg:p-8 shadow-2xl border border-slate-700/80 relative overflow-hidden space-y-6"
        >
          {/* Close button */}
          <button
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-xl bg-slate-800/40 border border-slate-700/50 flex items-center justify-between">
              ...
              <span className="font-bold text-slate-200">SQLite3 WAL Mode</span>
            </div>
          ...
          <div className="p-4 rounded-2xl bg-indigo-950/30 border border-indigo-500/20 text-xs text-slate-300">
            <p className="font-semibold text-indigo-300 mb-1">Gmail Sync Strategy</p>
